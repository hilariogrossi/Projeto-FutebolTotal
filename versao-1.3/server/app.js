...
app.get('/noticias-r7', async (req, res) => {

    try {
        const response = await axios.get('https://esportes.r7.com/futebol/feed.xml');
        ...
        console.error('Erro ao obter as notícias do R7', error);
        
        res.status(500).json({ error: 'Erro ao obter as notícias do R7!' });
